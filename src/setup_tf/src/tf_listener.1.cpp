...
const int tagNum = 6; //number of tags in system
const int robotId = 3;// index of robot tag (not used to create map)
string tagName[]={"tag4","tag5","tag12","tag6","tag10","tag11"}; //name of all the tags in the system
...
int obsTags[] = {4,5}; //index of obstical tags
rectangle tagShape[2]; //shape of obsticals

tagShape[0].height = .2; //define obstical 1
tagShape[0].width = .4;

tagShape[1].height = .2; //define obstical 2
tagShape[1].width = .2;
